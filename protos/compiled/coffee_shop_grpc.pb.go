...
type CoffeeShopClient interface {
	GetMenu(ctx context.Context, in *GetMenuRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Menu], error)
...
func (c *coffeeShopClient) GetMenu(ctx context.Context, in *GetMenuRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Menu], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &CoffeeShop_ServiceDesc.Streams[0], CoffeeShop_GetMenu_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetMenuRequest, Menu]{ClientStream: stream}
...
type CoffeeShopServer interface {
	GetMenu(*GetMenuRequest, grpc.ServerStreamingServer[Menu]) error
...
func (UnimplementedCoffeeShopServer) GetMenu(*GetMenuRequest, grpc.ServerStreamingServer[Menu]) error {
...
func _CoffeeShop_GetMenu_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(CoffeeShopServer).GetMenu(m, &grpc.GenericServerStream[GetMenuRequest, Menu]{ServerStream: stream})
}
